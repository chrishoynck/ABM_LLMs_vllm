...
# (run_simulation_sda.sh is the SDA counterpart with the same settings.)
#
...
#
# Called via jobs/run_simulation_sdc.job (SLURM resources allocated there).
# Can also run interactively:  bash scripts/simulation/run_simulation_sdc.sh
