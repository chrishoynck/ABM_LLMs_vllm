...
# by another student generator (Gemma 4 / Kimi-Linear) via run_finetune.sh with
...
#   POSTS=path/to/other.csv bash scripts/assessment/run_llm_assessor_on_heldout.sh kimi
#
...
TAG="${1:?usage: run_llm_assessor_on_heldout.sh <tag>   (e.g. gemma4, kimi)}"
