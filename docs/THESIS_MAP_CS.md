...
| App. C §Classification vs. Embedding Space | `src/utils/tools/plot_assessment_diagnostics.py` (`all`) | hand-run — see `../src/README.md` ("Hand-run CLIs") | `data/test_post/bert_regression/test_blocks_seed35.csv` |
